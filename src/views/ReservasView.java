...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("")
			...
			JOptionPane.showMessageDialog(contentPane, "¡Se ha realizado la reserva con éxito!, número de reserva: "
											+ nuevaReserva.getId());
	...
	public void calcularValor(JDateChooser fechaE, JDateChooser fechaS) {
		if(fechaE.getDate()!= null && fechaS != null) {
			if(fechaE.getDate().after(fechaS.getDate())) {
				JOptionPane.showMessageDialog(null, "La fecha de entrada no puede ser posterior a la de salida", 
